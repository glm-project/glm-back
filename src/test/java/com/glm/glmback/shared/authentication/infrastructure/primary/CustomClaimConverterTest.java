...
class CustomClaimConverterTest {
  ...
  private final class UserBuilder {
    ...
    private UserBuilder givenName(String givenName) {
      user.put("given_name", givenName);

      return this;
    }

    private UserBuilder familyName(String familyName) {
    ...
    private UserBuilder groups(String... groups) {
    ...
    private UserBuilder namespaceRoles(String... roles) {
    ...
    private UserBuilder roles(String... roles) {
    ...
    private UserBuilder name(String name) {
      user.put("name", name);
