package com.glm.glmback.shared.collection.domain;
...
@UnitTest
class GlmprojectCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class GlmprojectCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = GlmprojectCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = GlmprojectCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class GlmprojectCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = GlmprojectCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = GlmprojectCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class GlmprojectCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = GlmprojectCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = GlmprojectCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class GlmprojectMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = GlmprojectCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = GlmprojectCollections.immutable(input);
