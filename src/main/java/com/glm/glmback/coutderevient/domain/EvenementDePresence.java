...
/**
 * Un pointage de presence, reduit a ce que la valorisation a besoin d'en savoir.
 *
 * <p>
 * Ni auteur, ni date d'enregistrement, ni annulation : la correction est l'affaire de l'atelier, et les evenements
 * annules sont ecartes des la requete. Ce qui reste est le seul fait qui compte ici — un type, a une heure.
 * </p>
 */
