...
2. **La quarantaine des gestes refusés reste à faire**, côté serveur : un rejeu refusé pour raison métier —
   ...
   retirée est enregistrée et signalée. En revanche, un geste rattaché à rien — opérateur, poste ou OF inconnu, geste
   hors séquence, identifiant réutilisé — reste refusé et ne vit que dans le journal local du pupitre : la mise en
   attente côté serveur (lot 8c) a été écartée le 26/09/2026.
